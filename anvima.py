...
if type_of_virus == 'B' or type_of_virus == 'b':
    ...
    sys.exit()
elif type_of_virus == 'D' or type_of_virus == 'd':
    print '\n %s[%s+%s]%s Download the virus%s...%s' % (Y, R, Y, G, R, N)
    ...
    print ' %s[%s+%s]%s Done%s.%s' % (Y, R, Y, G, R, N)
    sys.exit()
elif type_of_virus == 'F' or type_of_virus == 'f':
    print '\n %s[%s+%s]%s Download the virus%s...%s' % (Y, R, Y, G, R, N)
    ...
    print ' %s[%s+%s]%s Done%s.%s' % (Y, R, Y, G, R, N)
    sys.exit()
elif type_of_virus == 'BO' or type_of_virus == 'bo':
    print '\n %s[%s+%s]%s Download the virus%s...%s' % (Y, R, Y, G, R, N)
    ...
    print ' %s[%s+%s]%s Done%s.%s' % (Y, R, Y, G, R, N)
    sys.exit()
elif type_of_virus == 'E' or type_of_virus == 'e':
    print '\n %s[%s+%s]%s Download the virus%s...%s' % (Y, R, Y, G, R, N)
